...
xmin = -.22
xmax = 1
avvv[0] = plt_setp(ax[0], xmin, xmax, time, power, [.04, 1.04, .095, .0255], "2.2V")

time, power = read("sys_2v5.csv", 2.5)
xmin = -.35
xmax = .85
avvv[1] = plt_setp(ax[1], xmin, xmax, time, power, [.04, 1.025, .095, .0255], "2.5V")

time, power = read("sys_2v8.csv", 2.8)
xmin = -.35
xmax = .95
avvv[2] = plt_setp(ax[2], xmin, xmax, time, power, [.035, 1.015, .095, .13], "2.8V")

time, power = read("sys_3v0.csv", 3.0)
xmin = -.075
xmax = 1.225
avvv[3] = plt_setp(ax[3], xmin, xmax, time, power, [.0375, 1.01, .095, .135], "3.0V")

time, power = read("sys_3v3.csv", 3.3)
xmin = -.25
xmax = 1.05
avvv[4] = plt_setp(ax[4], xmin, xmax, time, power, [.05, 1.005, .0925, .13], "3.3V")

time, power = read("sys_3v6.csv", 3.6)
xmin = -.25
xmax = 1.05
avvv[5] = plt_setp(ax[5], xmin, xmax, time, power, [.04, 1, .095, .13], "3.6V", xlabel=True)
