...
xmin = -3
xmax = 3.8
avvv[0] = plt_setp(ax[0], xmin, xmax, time, power, [.1, 5.99, .5475, .1375], "8MHz", xlabel=True)

time, power = read("mcu_clk_16MHz.csv")
xmin = 0.1
xmax = 3.65
avvv[1] = plt_setp(ax[1], xmin, xmax, time, power, [.1, 3.005, .275, .1375], "16MHz")

time, power = read("mcu_clk_24MHz.csv")
xmin = -.135
xmax = 2.3
avvv[2] = plt_setp(ax[2], xmin, xmax, time, power, [.1, 2, .185, .135], "24MHz", xlabel=True)

time, power = read("mcu_clk_32MHz.csv")
xmin = -.1
xmax = 1.8
avvv[3] = plt_setp(ax[3], xmin, xmax, time, power, [.1, 1.5, .14, .136], "32MHz", xlabel=True)

time, power = read("mcu_clk_40MHz.csv")
xmin = 0.025
xmax = 1.55
avvv[4] = plt_setp(ax[4], xmin, xmax, time, power, [.05, 1.205, .1125, .1345], "40MHz", xlabel=True)
...
xmin = 0.175
xmax = 1.45
avvv[5] = plt_setp(ax[0], xmin, xmax, time, power, [.025, 1.01, .0925, .135], "48MHz")

time, power = read("mcu_clk_56MHz.csv")
xmin = 0.275
xmax = 1.375
avvv[6] = plt_setp(ax[1], xmin, xmax, time, power, [.015, .8625, .082, .1325], "56MHz")

time, power = read("mcu_clk_64MHz.csv")
xmin = 0.315
xmax = 1.3
avvv[7] = plt_setp(ax[2], xmin, xmax, time, power, [.015, .7525, .072, .135], "64MHz", xlabel=True)

time, power = read("mcu_clk_72MHz.csv")
xmin = 0.315
xmax = 1.21
avvv[8] = plt_setp(ax[3], xmin, xmax, time, power, [.015, .6735, .065, .132], "72MHz")

time, power = read("mcu_clk_80MHz.csv")
xmin = 0.41
xmax = 1.23
avvv[9] = plt_setp(ax[4], xmin, xmax, time, power, [.015, .605, .058, .13], "80MHz", xlabel=True)
