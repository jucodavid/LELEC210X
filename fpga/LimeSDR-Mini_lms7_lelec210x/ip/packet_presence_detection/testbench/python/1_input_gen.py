...
# Save
np.savetxt("../mentor/input_fpga.txt",input_array_q,fmt="%.6x")
...
output_array_fused_q = np.loadtxt("../mentor/input_fpga.txt",delimiter=" ",converters={0:lambda s: int(s,16)}).astype(np.int32)
