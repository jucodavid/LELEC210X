% ================================================================================
% Legal Notice: Copyright (C) 2024 Intel Corporation. All rights reserved.
...
% ================================================================================
% Generated on: 11/06/2024 22:08:21
...
for j = 1:sx
    ...
    %
    file_name = ['lms_dsp_fir_compiler_ii_0_input.txt'];
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = lms_dsp_fir_compiler_ii_0_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['lms_dsp_fir_compiler_ii_0_model_output'];
