...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fir_tb_gen_fir_compiler_ii_0_rtl_core.vhd"       -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fir_tb_gen_fir_compiler_ii_0_ast.vhd"            -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fir_tb_gen_fir_compiler_ii_0.vhd"                -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fir_tb_gen_fir_compiler_ii_0_tb.vhd"             -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/fir_tb_gen.v"                                                                                                                   
fi
