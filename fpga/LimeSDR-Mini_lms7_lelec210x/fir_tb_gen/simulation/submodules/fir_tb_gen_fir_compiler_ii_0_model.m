...
% ================================================================================
% Generated on: 05/04/2025 14:13:33
...
for j = 1:sx
    ...
    %
    file_name = ['fir_tb_gen_fir_compiler_ii_0_input.txt'];
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = fir_tb_gen_fir_compiler_ii_0_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['fir_tb_gen_fir_compiler_ii_0_model_output'];
