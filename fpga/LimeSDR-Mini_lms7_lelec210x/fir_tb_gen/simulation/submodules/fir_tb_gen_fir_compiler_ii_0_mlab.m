...
function  output = fir_tb_gen_fir_compiler_ii_0_mlab(stimulation, bank);
 coef_matrix_in= [0,0,0,0,-2,-3,0,6,8,0,-16,-22,0,50,103,127,103,50,0,-22,-16,0,8,6,0,-3,-2,0,0,0,0];
 INTER_FACTOR  = 1;
 DECI_FACTOR  =  1;
 MSB_RM  = 4;
 MSB_TYPE  = 0;
