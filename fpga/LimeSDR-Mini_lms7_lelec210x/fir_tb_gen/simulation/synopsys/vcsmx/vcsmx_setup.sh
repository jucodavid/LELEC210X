...
# ACDS 18.1 625 win32 2025.05.05.15:21:53
...
# ----------------------------------------
# If fir_tb_gen is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/fir_tb_gen_fir_compiler_ii_0_rtl_core.vhd"       -work fir_compiler_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/fir_tb_gen_fir_compiler_ii_0_ast.vhd"            -work fir_compiler_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/fir_tb_gen_fir_compiler_ii_0.vhd"                -work fir_compiler_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/fir_tb_gen_fir_compiler_ii_0_tb.vhd"             -work fir_compiler_ii_0
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_tb_gen.v"                                                                      
fi
