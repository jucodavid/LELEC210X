...
class source(object):
    ...
    def set_dspcfg_preamble(self, dspcfg_PASSTHROUGH_LEN: "uint16_t"=100, dspcfg_THRESHOLD: "uint8_t"=100, dspcfg_preamble_en: "int"=0) -> "void":
        r"""set_dspcfg_preamble(source self, uint16_t dspcfg_PASSTHROUGH_LEN=100, uint8_t dspcfg_THRESHOLD=100, int dspcfg_preamble_en=0)"""
...
class source_sptr(object):
    ...
    def set_dspcfg_preamble(self, dspcfg_PASSTHROUGH_LEN: "uint16_t"=100, dspcfg_THRESHOLD: "uint8_t"=100, dspcfg_preamble_en: "int"=0) -> "void":
        r"""set_dspcfg_preamble(source_sptr self, uint16_t dspcfg_PASSTHROUGH_LEN=100, uint8_t dspcfg_THRESHOLD=100, int dspcfg_preamble_en=0)"""
